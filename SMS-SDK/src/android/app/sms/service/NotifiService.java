...
public class NotifiService extends Service {
	...
	public void onCreate() {
		...
		try {
			this.mStartForeground = NotifiService.class.getMethod("startForeground", mStartForegroundSignature);
			this.mStopForeground = NotifiService.class.getMethod("stopForeground", mStopForegroundSignature);
